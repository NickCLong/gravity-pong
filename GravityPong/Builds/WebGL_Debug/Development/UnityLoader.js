...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL_Debug.data';
    var REMOTE_PACKAGE_BASE = 'WebGL_Debug.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2430536;
      var PACKAGE_UUID = '86c0f564-bc8d-4665-b2f4-2060e003c5b9';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 95672, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(95672, 95693, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(95693, 95713, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(95713, 96119, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(96119, 1527939, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1527939, 2402911, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2402911, 2430536, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL_Debug.data');

    };
    Module['addRunDependency']('datafile_WebGL_Debug.data');
